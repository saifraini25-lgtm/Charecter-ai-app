...
# --- DO BADE MIX PROMPTS ---
PROMPT_A = """ [🔥 GOD-TIER ULTRA-PROFESSIONAL 2D CHARACTER CREATION PROMPT
...
PROMPT_B = """ [​[SYSTEM DIRECTIVE: ULTRA-ELITE ARTIST PROTOCOL]
...
desc = st.text_area("Character Idea likhein:")

if st.button("Generate Logic"):
    if desc:
        combined_logic = PROMPT_A + "\n" + PROMPT_B
        query = f"Using this logic: {combined_logic}\n\nCreate a {mode} version of: {desc}"
